...
namespace N_Aco
{
    ...
    void atualizaFeromonio(Matrix<double> &matFeromonio, Matrix<double> &matAtualFeromonio,
                           Instancia &instancia, const AcoParametros &acoParam, const Ant &antBest, const Vector<Ant> &vetAnt);
    void evaporaFeromonio(Matrix<double> &matFeromonio, const Vector<int> &vetSat, Instancia &instancia, const AcoParametros &acoParam, const double feromMin);
